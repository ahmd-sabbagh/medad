        ...
        <div className="flex lg:flex-col items-center gap-4 lg:gap-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-center gap-4">
              <Link href={"/submit-application-event"} className="px-8 py-1 bg-[#C39E61] text-black rounded-[5px] text-xl font-black  transition-transform duration-300 hover:scale-105  cursor-pointer">
                سجل الآن
              </Link>
