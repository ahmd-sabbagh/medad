...
const HaveAquestion = () => {
  ...
  return (
    <section className="pt-10 md:pt-20 mt-10">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-bold text-xl md:text-2xl">{"medad@info.com"}</span>
            </div>
          </div>
          {/*  */}
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-bold text-xl md:text-2xl">{"+٩٦٦٥٥١٩٧٩٣٥٠"}</span>
            </div>
          </div>
        </div>
      </div>
