      ...
      <div className="container">
        <div className="md:max-w-[80%] mx-auto">
          <h3 className="text-xl md:text-2xl font-bold ">
            {t("Submit an application to participate in the exhibition")}
          </h3>
          <form className="flex flex-col gap-3 mt-8 max-w-[80%] mx-auto">
            <input
              type="text"
            ...
            <button type="button" className=" cursor-pointer mt-[10px] block w-full rounded-xl h-[60px] lg:h-[74px] bg-main text-center text-white font-bold text-lg">
